        ...
        connected = rowss[0];
                ...
                if (rows.length) {
                        ...
                        if (sort == 'Common Tags') {
                                ...
                                const[tags] = await connection.execute(qr,[ connected.id, rows[i].id ]);
                                    ...
                                    if (i == rows.length - 1)
                                    {
                                        ...
                                        WHERE id_user = ?;", [row.id]);
                                                ...
                                                res.render('match', { title: 'Match', row, session, sort, order, final_tags,distance_range ,age_0,age_1,common_count,fame,common_tagsfinal});
                                    }
                            }    
                        }
                        else {
                         ...
                         user_tags, session, sort, order,distance_range ,age_0,age_1,common_count,fame,final_tags});
                        }
                    } else
